...
def main(args):
    ...
    for epoch in range(args.n_epochs):
        ...
        # Evaluation
        valid_loss, valid_r2 = evaluate(model, valid_loader,loss_function)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_filename", type=str, default="trained/regression_date", help="Save location for the model")
    ...
    parser.add_argument("--data_path", type=str, default="swerick_subsetdata_date_train.csv", help="Training data as a .CSV file. Needs to have 'content' (X) and 'tag' (Y) columns.")
